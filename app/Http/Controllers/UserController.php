...
class UserController extends Controller
{
    ...
    function changePassword(Request $request) {
        ...
        if (Hash::check($request->oldpassword, $user->password)) {
            ...
            return redirect('admin')->with(['password' => true]);
        } else {
            return redirect('admin')->with(['passworderror' => false])->withErrors(['passworderror' => 'No se ha podido cambiar la clave debido a que la clave anterior no es correcta. No funciona. Por qué?']);
        }
    }
