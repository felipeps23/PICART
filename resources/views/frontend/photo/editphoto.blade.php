        ...
        <section class="section-single">
            ...
            <div class="container container-single" >
                <div class="row row-single" >
                    <div class="col-12">
                      <h1> <b>PIC-ART</b>  — {{ $photo->user->nickname }}</h1>
                    </div>
                    <div class="col-12 col-createphoto">
                       <div class="form-createphoto">
                           <form role="form" action="{{ url('/home/photos/' . $photo->id . '/edit') }}" method="post" id="editPhotoForm" enctype="multipart/form-data">
                              @csrf
                              @method('put')
                               <h1>Edit Photo</h1>
                                 
                                 <div class="center-img-file">
                                       <img id="output" src="data:image/png;base64,{{ $photo->photo }}"></img> 
                                 </div>
                               ...
                               <select class="custom-select w-100" name="idpreset" id="idpreset" required="">
                                ...
                                <input id="camera" type="text" class="form-control " name="camera" value="{{ old('camera', $photo->camera) }}" required="" >
                                <div class="divider-form">
                                    <div>
                                       ...
                                       <input id="lens" type="text" class="form-control " name="lens" value="{{ old('lens', $photo->lens) }}" required="" >
                                   </div>
                                   <div>
                                       ...
                                       <input id="shutter_speed" type="text" class="form-control " name="shutter_speed" value="{{ old('shutter_speed', $photo->shutter_speed) }}" required="" >
                                   </div>
                                </div>
                                 ...
                                 <div class="divider-form">
                                    <div>
                                       ...
                                       <input id="iso" type="text" class="form-control " name="iso" value="{{ old('iso', $photo->iso) }}" required="" >
                                   </div>
                                   <div>
