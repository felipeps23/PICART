  ...
  <body id="feed-picart">
         ...
         <div class="nav-home">
            ...
            <ul>
                ...
                <li> <a href="{{ url('/feed') }}"><b>Feed</b></a> </li>
        ...
        <section class="section-gallery">
            ...
            <div class="container container-gallery" >
                <div class="row row-gallery" >
                    <div class="col-12">
                      <h1> <b>PIC-ART</b>  — For creators, by creators</h1>
                    </div>
                    <div class="col-12">
                        <div class="gallery-feed">
                            ...
                            <div class="item">
                                <a href="{{ url('home/photos/' . $photo->id  ) }}">
                                <img src="data:image/png;base64,{{ $photo->photo }}"></img> 
                                </a>
                                <div class="user-see">
                                    <h5>{{ $photo->user->nickname }}</h5>
                                    <a data-fancybox="gallery" href="data:image/png;base64,{{ $photo->photo }}">
                            ...
                            <div class="item">
                                ...
                                <div class="user-see">
                                    <h5>sergiomh</h5>
                                    <a data-fancybox="gallery" href="{{url('/assets/frontend/images/2.jpg')}}">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="eye" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="svg-inline--fa fa-eye fa-w-18 fa-fw fa-2x"><path fill="currentColor" d="M572.52 241.4C518.29 135.59 410.93 64 288 64S57.68 135.64 3.48 241.41a32.35 32.35 0 0 0 0 29.19C57.71 376.41 165.07 448 288 448s230.32-71.64 284.52-177.41a32.35 32.35 0 0 0 0-29.19zM288 400a144 144 0 1 1 144-144 143.93 143.93 0 0 1-144 144zm0-240a95.31 95.31 0 0 0-25.31 3.79 47.85 47.85 0 0 1-66.9 66.9A95.78 95.78 0 1 0 288 160z" class=""></path></svg>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                ...
                                <div class="user-see">
                                    <h5>sergiomh</h5>
                                    <a data-fancybox="gallery" href="{{url('/assets/frontend/images/3.jpg')}}">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="eye" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="svg-inline--fa fa-eye fa-w-18 fa-fw fa-2x"><path fill="currentColor" d="M572.52 241.4C518.29 135.59 410.93 64 288 64S57.68 135.64 3.48 241.41a32.35 32.35 0 0 0 0 29.19C57.71 376.41 165.07 448 288 448s230.32-71.64 284.52-177.41a32.35 32.35 0 0 0 0-29.19zM288 400a144 144 0 1 1 144-144 143.93 143.93 0 0 1-144 144zm0-240a95.31 95.31 0 0 0-25.31 3.79 47.85 47.85 0 0 1-66.9 66.9A95.78 95.78 0 1 0 288 160z" class=""></path></svg>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <img src="{{url('/assets/frontend/images/4.jpg')}}"></img> 
                                <div class="user-see">
                                    <h5>sergiomh</h5>
                                    <a data-fancybox="gallery" href="{{url('/assets/frontend/images/4.jpg')}}">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="eye" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="svg-inline--fa fa-eye fa-w-18 fa-fw fa-2x"><path fill="currentColor" d="M572.52 241.4C518.29 135.59 410.93 64 288 64S57.68 135.64 3.48 241.41a32.35 32.35 0 0 0 0 29.19C57.71 376.41 165.07 448 288 448s230.32-71.64 284.52-177.41a32.35 32.35 0 0 0 0-29.19zM288 400a144 144 0 1 1 144-144 143.93 143.93 0 0 1-144 144zm0-240a95.31 95.31 0 0 0-25.31 3.79 47.85 47.85 0 0 1-66.9 66.9A95.78 95.78 0 1 0 288 160z" class=""></path></svg>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <img src="{{url('/assets/frontend/images/5.jpg')}}"></img> 
                                <div class="user-see">
                                    <h5>sergiomh</h5>
                                    <a data-fancybox="gallery" href="{{url('/assets/frontend/images/5.jpg')}}">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="eye" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="svg-inline--fa fa-eye fa-w-18 fa-fw fa-2x"><path fill="currentColor" d="M572.52 241.4C518.29 135.59 410.93 64 288 64S57.68 135.64 3.48 241.41a32.35 32.35 0 0 0 0 29.19C57.71 376.41 165.07 448 288 448s230.32-71.64 284.52-177.41a32.35 32.35 0 0 0 0-29.19zM288 400a144 144 0 1 1 144-144 143.93 143.93 0 0 1-144 144zm0-240a95.31 95.31 0 0 0-25.31 3.79 47.85 47.85 0 0 1-66.9 66.9A95.78 95.78 0 1 0 288 160z" class=""></path></svg>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <img src="{{url('/assets/frontend/images/6.jpg')}}"></img> 
                                <div class="user-see">
                                    <h5>sergiomh</h5>
                                    <a data-fancybox="gallery" href="{{url('/assets/frontend/images/6.jpg')}}">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="eye" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="svg-inline--fa fa-eye fa-w-18 fa-fw fa-2x"><path fill="currentColor" d="M572.52 241.4C518.29 135.59 410.93 64 288 64S57.68 135.64 3.48 241.41a32.35 32.35 0 0 0 0 29.19C57.71 376.41 165.07 448 288 448s230.32-71.64 284.52-177.41a32.35 32.35 0 0 0 0-29.19zM288 400a144 144 0 1 1 144-144 143.93 143.93 0 0 1-144 144zm0-240a95.31 95.31 0 0 0-25.31 3.79 47.85 47.85 0 0 1-66.9 66.9A95.78 95.78 0 1 0 288 160z" class=""></path></svg>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <img src="{{url('/assets/frontend/images/7.jpg')}}"></img> 
                                <div class="user-see">
                                    <h5>sergiomh</h5>
                                    <a data-fancybox="gallery" href="{{url('/assets/frontend/images/7.jpg')}}">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="eye" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="svg-inline--fa fa-eye fa-w-18 fa-fw fa-2x"><path fill="currentColor" d="M572.52 241.4C518.29 135.59 410.93 64 288 64S57.68 135.64 3.48 241.41a32.35 32.35 0 0 0 0 29.19C57.71 376.41 165.07 448 288 448s230.32-71.64 284.52-177.41a32.35 32.35 0 0 0 0-29.19zM288 400a144 144 0 1 1 144-144 143.93 143.93 0 0 1-144 144zm0-240a95.31 95.31 0 0 0-25.31 3.79 47.85 47.85 0 0 1-66.9 66.9A95.78 95.78 0 1 0 288 160z" class=""></path></svg>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <img src="{{url('/assets/frontend/images/8.jpg')}}"></img> 
                                <div class="user-see">
                                    <h5>sergiomh</h5>
                                    <a data-fancybox="gallery" href="{{url('/assets/frontend/images/8.jpg')}}">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="eye" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="svg-inline--fa fa-eye fa-w-18 fa-fw fa-2x"><path fill="currentColor" d="M572.52 241.4C518.29 135.59 410.93 64 288 64S57.68 135.64 3.48 241.41a32.35 32.35 0 0 0 0 29.19C57.71 376.41 165.07 448 288 448s230.32-71.64 284.52-177.41a32.35 32.35 0 0 0 0-29.19zM288 400a144 144 0 1 1 144-144 143.93 143.93 0 0 1-144 144zm0-240a95.31 95.31 0 0 0-25.31 3.79 47.85 47.85 0 0 1-66.9 66.9A95.78 95.78 0 1 0 288 160z" class=""></path></svg>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <img src="{{url('/assets/frontend/images/9.jpg')}}"></img> 
                                <div class="user-see">
                                    <h5>sergiomh</h5>
                                    <a data-fancybox="gallery" href="{{url('/assets/frontend/images/9.jpg')}}">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="eye" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="svg-inline--fa fa-eye fa-w-18 fa-fw fa-2x"><path fill="currentColor" d="M572.52 241.4C518.29 135.59 410.93 64 288 64S57.68 135.64 3.48 241.41a32.35 32.35 0 0 0 0 29.19C57.71 376.41 165.07 448 288 448s230.32-71.64 284.52-177.41a32.35 32.35 0 0 0 0-29.19zM288 400a144 144 0 1 1 144-144 143.93 143.93 0 0 1-144 144zm0-240a95.31 95.31 0 0 0-25.31 3.79 47.85 47.85 0 0 1-66.9 66.9A95.78 95.78 0 1 0 288 160z" class=""></path></svg>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <img src="{{url('/assets/frontend/images/10.jpg')}}"></img> 
                                <div class="user-see">
                                    <h5>sergiomh</h5>
                                    <a data-fancybox="gallery" href="{{url('/assets/frontend/images/10.jpg')}}">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="eye" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="svg-inline--fa fa-eye fa-w-18 fa-fw fa-2x"><path fill="currentColor" d="M572.52 241.4C518.29 135.59 410.93 64 288 64S57.68 135.64 3.48 241.41a32.35 32.35 0 0 0 0 29.19C57.71 376.41 165.07 448 288 448s230.32-71.64 284.52-177.41a32.35 32.35 0 0 0 0-29.19zM288 400a144 144 0 1 1 144-144 143.93 143.93 0 0 1-144 144zm0-240a95.31 95.31 0 0 0-25.31 3.79 47.85 47.85 0 0 1-66.9 66.9A95.78 95.78 0 1 0 288 160z" class=""></path></svg>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <img src="{{url('/assets/frontend/images/11.jpg')}}"></img> 
                                <div class="user-see">
                                    <h5>sergiomh</h5>
                                    <a data-fancybox="gallery" href="{{url('/assets/frontend/images/11.jpg')}}">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="eye" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="svg-inline--fa fa-eye fa-w-18 fa-fw fa-2x"><path fill="currentColor" d="M572.52 241.4C518.29 135.59 410.93 64 288 64S57.68 135.64 3.48 241.41a32.35 32.35 0 0 0 0 29.19C57.71 376.41 165.07 448 288 448s230.32-71.64 284.52-177.41a32.35 32.35 0 0 0 0-29.19zM288 400a144 144 0 1 1 144-144 143.93 143.93 0 0 1-144 144zm0-240a95.31 95.31 0 0 0-25.31 3.79 47.85 47.85 0 0 1-66.9 66.9A95.78 95.78 0 1 0 288 160z" class=""></path></svg>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <img src="{{url('/assets/frontend/images/12.jpg')}}"></img> 
                                <div class="user-see">
                                    <h5>sergiomh</h5>
                                    <a data-fancybox="gallery" href="{{url('/assets/frontend/images/12.jpg')}}">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="eye" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="svg-inline--fa fa-eye fa-w-18 fa-fw fa-2x"><path fill="currentColor" d="M572.52 241.4C518.29 135.59 410.93 64 288 64S57.68 135.64 3.48 241.41a32.35 32.35 0 0 0 0 29.19C57.71 376.41 165.07 448 288 448s230.32-71.64 284.52-177.41a32.35 32.35 0 0 0 0-29.19zM288 400a144 144 0 1 1 144-144 143.93 143.93 0 0 1-144 144zm0-240a95.31 95.31 0 0 0-25.31 3.79 47.85 47.85 0 0 1-66.9 66.9A95.78 95.78 0 1 0 288 160z" class=""></path></svg>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <img src="{{url('/assets/frontend/images/13.jpg')}}"></img> 
                                <div class="user-see">
                                    <h5>sergiomh</h5>
                                    <a data-fancybox="gallery" href="{{url('/assets/frontend/images/13.jpg')}}">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="eye" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="svg-inline--fa fa-eye fa-w-18 fa-fw fa-2x"><path fill="currentColor" d="M572.52 241.4C518.29 135.59 410.93 64 288 64S57.68 135.64 3.48 241.41a32.35 32.35 0 0 0 0 29.19C57.71 376.41 165.07 448 288 448s230.32-71.64 284.52-177.41a32.35 32.35 0 0 0 0-29.19zM288 400a144 144 0 1 1 144-144 143.93 143.93 0 0 1-144 144zm0-240a95.31 95.31 0 0 0-25.31 3.79 47.85 47.85 0 0 1-66.9 66.9A95.78 95.78 0 1 0 288 160z" class=""></path></svg>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <img src="{{url('/assets/frontend/images/14.jpg')}}"></img> 
                                <div class="user-see">
                                    <h5>sergiomh</h5>
                                    <a data-fancybox="gallery" href="{{url('/assets/frontend/images/14.jpg')}}">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="eye" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="svg-inline--fa fa-eye fa-w-18 fa-fw fa-2x"><path fill="currentColor" d="M572.52 241.4C518.29 135.59 410.93 64 288 64S57.68 135.64 3.48 241.41a32.35 32.35 0 0 0 0 29.19C57.71 376.41 165.07 448 288 448s230.32-71.64 284.52-177.41a32.35 32.35 0 0 0 0-29.19zM288 400a144 144 0 1 1 144-144 143.93 143.93 0 0 1-144 144zm0-240a95.31 95.31 0 0 0-25.31 3.79 47.85 47.85 0 0 1-66.9 66.9A95.78 95.78 0 1 0 288 160z" class=""></path></svg>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <img src="{{url('/assets/frontend/images/15.jpg')}}"></img> 
                                <div class="user-see">
                                    <h5>sergiomh</h5>
                                    <a data-fancybox="gallery" href="{{url('/assets/frontend/images/15.jpg')}}">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="eye" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="svg-inline--fa fa-eye fa-w-18 fa-fw fa-2x"><path fill="currentColor" d="M572.52 241.4C518.29 135.59 410.93 64 288 64S57.68 135.64 3.48 241.41a32.35 32.35 0 0 0 0 29.19C57.71 376.41 165.07 448 288 448s230.32-71.64 284.52-177.41a32.35 32.35 0 0 0 0-29.19zM288 400a144 144 0 1 1 144-144 143.93 143.93 0 0 1-144 144zm0-240a95.31 95.31 0 0 0-25.31 3.79 47.85 47.85 0 0 1-66.9 66.9A95.78 95.78 0 1 0 288 160z" class=""></path></svg>
                                    </a>
                                </div>
                            </div>
