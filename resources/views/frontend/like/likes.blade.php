        ...
        <section class="section-gallery">
            ...
            <div class="container container-gallery" >
                <div class="row row-gallery" >
                    <div class="col-12">
                      <h1> <b>PIC-ART</b>  — My Likes Photos</h1>
                    </div>
                    <!-- <div class="col-12 col-createpreset">-->
                    <!--    <a href="" class="createpreset">Add Photo</a>-->
                    <!--</div>-->
                    <div class="col-12 col-likes">
                        
                        <div class="gallery-feed">
                            @foreach ($likes as $like)
                            <div class="item">
                                
                                <a href="{{ url('home/photos/' . $like->idphoto  ) }}"><img src="data:image/png;base64,{{ $like->photo }}"></img> </a>
                                <div class="user-see">
                                    
                                    <h5>{{ date('d-m-y', strtotime($like->datecreate)) }}</h5>   
