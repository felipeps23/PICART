        ...
        <section class="section-preset">
            ...
            <div class="container container-preset" >
                <div class="row row-preset" >
                    <div class="col-12">
                      <h1> <b>PIC-ART</b>  — My Saved Presets</h1>
                    </div>
                    <!--<div class="col-12 col-createpreset">-->
                    <!--    <a href="" class="createpreset">Add Preset</a>-->
                    <!--</div>-->
                        ...
                        <div class="gallery-preset">
                            ...
                            <div class="item">
                                <div class="preset-date">
                                    <h5>{{ date('d-m-y', strtotime($favourite->created_at)) }}</h5>
                                </div>
                                <a href="{{ url('home/presets/' . $favourite->idpreset  ) }}"><img src="data:image/png;base64,{{ $favourite->presetphoto }}"></img> </a>
                                <div class="user-see">
                                    <h5>{{ $favourite->pname }}</h5>
