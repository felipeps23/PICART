                           ...
                           <form role="form" action="{{ url('/mypresets/preset/updatecreate/' . $preset->id) }}" method="post" id="createPresetForm" enctype="multipart/form-data">
                              ...
                              @method('put')
                               <h1>Add Preset</h1>
                                 <div class="steps">
                                     <h3 >Step 1</h3>
                                     <h3 class="select-step">Step 2</h3>
                                 </div>
                                 <!--<div class="center-img-file">-->
                                 <!--     <img id="output" src="{{url('/assets/frontend/images/preset4.jpg')}}"></img> -->
                                 <!--</div>-->
                                ...
                                <input type="file" class="file-zip" id="file" name="file">
                                
                                <!--<label for="email">Name preset</label>-->
                                <!--<input id="name" type="text" class="form-control " placeholder="FP2" name="name" value="" required="" autocomplete="name" autofocus="">-->
                                
                                <!--<label for="email">Description</label>-->
                                <!--<textarea name="textarea" ></textarea>-->
                                <!--<label for="email">Price €</label>-->
                                <!--<input type="number" min="0" max="9999.99" step="0.01" required="" class="form-control" id="price" placeholder="20" name="price" value="">-->
                               
                                
                                    <div class="button-form">
                                        <a href="#" data-id="" data-name="" class="cancel-edit" id="enlaceBorrar">Cancel</a>
                                         <button type="submit">
                                    Finish
                                </button>
                                    </div>
