                            ...
                            <div class="item">
                                ...
                                <div class="save">
                                 	...
                                 	@else
                    				     ...
                    				     <form role="form" action="{{ url('/home/presets/favourite') }}" method="post" id="createLikeForm" enctype="multipart/form-data">
                                            @csrf
                                                    ...
                                                    <select style="display:none" name="idpreset" id="idpreset" required class="form-control">
                                                        <option value="{{ $preset->id }}" selected>{{ $preset->id }}</option>
                                                    </select>
            ...
            <div class="container container-form" >
                <div class="row row-form" >
                    <div class="col-12 col-form">
                        ...
                        <form role="form" action="{{ url('valuation/'. $preset->id) }}" method="post" id="createValuationForm" enctype="multipart/form-data">
                            @csrf
