  ...
  <body id="preset-picart">
      ...
      <div class="nav-home">
            ...
            <ul>
                ...
                <li> <a href="{{ url('/preset') }}"><b>Presets</b></a> </li>
                ...
                <div class="row row-preset" >
                    ...
                    <div class="col-12">
                        <div class="gallery-preset">
                            ...
                            <div class="item">
                                <div class="buy-preset"><a href="{{ url('home/presets/' . $preset->id) }}">View and buy</a></div>
                                <div class="preset-date">
                                    <h5>{{ date('d-m-y', strtotime($preset->created_at)) }}</h5>
                                </div>
