        ...
        <section class="section-single">
            ...
            <div class="container container-single" >
                <div class="row row-single" >
                    <div class="col-12">
                      <h1> <b>PIC-ART</b>  — {{ $preset->user->nickname }}</h1>
                    </div>
                    <div class="col-12 col-createphoto">
                       <div class="form-createphoto">
                           <form role="form" action="{{ url('/home/presets/' . $preset->id . '/edit') }}" method="post" id="editPresetForm" enctype="multipart/form-data">
                              @csrf
                              @method('put')
                               <h1>Edit Preset</h1>
                                 
                                 <div class="center-img-file">
                                      <img id="output" src="data:image/png;base64,{{ $preset->photo }}"></img> 
                                 </div>
                                ...
                                <textarea name="description" >{{ old('description', $preset->description) }}</textarea>
                                <label for="price">Price €</label>
                                <input type="number" min="0" max="9999.99" step="0.01" required="" class="form-control" id="price" name="price" value="{{ old('price', $preset->price) }}">
