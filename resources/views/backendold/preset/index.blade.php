               ...
               <div class="table-responsive">
                ...
                @foreach ($presets as $preset)
                    <tr>
                        ...
                        <td><a href="{{ url('backend/preset/' . $preset->id) }}" class="btn btn-info">Show</a></td>
                        <td><a href="{{ url('backend/preset/' . $preset->id . '/edit') }}" class="btn btn-success">Edit</a></td>
                        <td><a href="#" data-id="{{ $preset->id }}" class="enlaceBorrar btn btn-danger" >Delete</a></td>
                    </tr>
                @endforeach
                </tbody>
                </table>
