...
<div class="panel panel-white">
    <div class="panel-heading clearfix">
        <h4 class="panel-title">Creating a favourite</h4>
    </div>
    <div class="panel-body">
    <form role="form" action="{{ url('backend/favourite') }}" method="post" id="createFavouriteForm" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
