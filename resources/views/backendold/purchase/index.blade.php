               ...
               <div class="table-responsive">
                ...
                @foreach ($purchases as $purchase)
                    <tr>
                        ...
                        <td><a href="{{ url('backend/purchase/' . $purchase->id) }}" class="btn btn-info">Show</a></td>
                        <td><a href="{{ url('backend/purchase/' . $purchase->id . '/edit') }}" class="btn btn-success">Edit</a></td>
                        <td><a href="#" data-id="{{ $purchase->id }}" class="enlaceBorrar btn btn-danger" >Delete</a></td>
                    </tr>
                @endforeach
                </tbody>
                </table>
