...
<head>
        ...
        <!-- Title -->
        <title>PIC-ART | The web to our photographers</title>
                    ...
                    <div class="page-sidebar-menu">
                        <ul class="accordion-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    <li><a href="#"><i class="menu-icon icon-eye"></i>View all photos</a></li>
                                    <li><a href="#"><i class="menu-icon icon-plus"></i>Create a new photo</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                ...
                                <ul class="sub-menu">
                                    <li><a href="#"><i class="menu-icon icon-eye"></i>View all presets</a></li>
                                    <li><a href="#"><i class="menu-icon icon-plus"></i>Create a new preset</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                ...
                                <ul class="sub-menu">
                                    <li><a href="#"><i class="menu-icon icon-eye"></i>View all comments</a></li>
                                    <li><a href="#"><i class="menu-icon icon-plus"></i>Create a new comment</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="charts.html">
                                ...
                                <ul class="sub-menu">
                                    <li><a href="#"><i class="menu-icon icon-eye"></i>View all favourites</a></li>
                                    <li><a href="#"><i class="menu-icon icon-plus"></i>Create a new favourite</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                ...
                                <ul class="sub-menu">
                                    <li><a href="#"><i class="menu-icon icon-eye"></i>View all likes</a></li>
                                    <li><a href="#"><i class="menu-icon icon-plus"></i>Create a new like</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                ...
                                <ul class="sub-menu">
                                    <li><a href="#"><i class="menu-icon icon-eye"></i>View all purchases</a></li>
                                    <li><a href="#"><i class="menu-icon icon-plus"></i>Create a new purchase</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                ...
                                <ul class="sub-menu">
                                    <li><a href="#"><i class="menu-icon icon-eye"></i>View all valuations</a></li>
                                    <li><a href="#"><i class="menu-icon icon-plus"></i>Create a new valuation</a></li>
                                </ul>
                            </li>
                            <li class="menu-divider"></li>
                            <li>
                                <a href="javascript:void(0)">
                                    <i class="menu-icon icon-user"></i><span>Users</span><i class="accordion-icon icon-sort"></i>
                                </a>
                                <ul class="sub-menu">
                                    <li><a href="{{ route('backend.user.index') }}"><i class="menu-icon icon-eye"></i>View all users</a></li>
                                    <li><a href="{{ route('backend.user.create') }}"><i class="menu-icon icon-plus"></i>Create a new user</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
