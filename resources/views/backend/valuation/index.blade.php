               ...
               <div class="table-responsive">
                ...
                @foreach ($valuations as $valuation)
                    <tr>
                        ...
                        <td><img src="data:image/png;base64,{{ $valuation->preset->photo }}" style="width: 53px;
    height: 50px;
    border-radius: 100%;
    object-fit: cover;"></td>
                        <td><a href="{{ url('backend/valuation/' . $valuation->id) }}" class="btn btn-inverse-primary btn-fw">Show</a></td>
                        <td><a href="{{ url('backend/valuation/' . $valuation->id . '/edit') }}" class="btn btn-inverse-success btn-fw">Edit</a></td>
                        <td><a href="#" data-id="{{ $valuation->id }}" class="enlaceBorrar btn btn-inverse-danger btn-fw" >Delete</a></td>
                    </tr>
                @endforeach
                </tbody>
                </table>
