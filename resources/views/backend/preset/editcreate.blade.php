...
<div class="col-12 grid-margin stretch-card">
    ...
    <form role="form" action="{{ url('backend/preset/updatecreate/' . $preset->id) }}" method="post" id="editPresetForm" enctype="multipart/form-data">
        @csrf
        @method('put')
        <div class="card-body">
            ...
            <div class="form-group" style="display:none">
             ...
             <div class="form-group">
                ...
                <input type="file" class="form-control" id="file" name="file" accept=".zip,.rar,.7zip" required>
           </div>
            <div class="form-group" style="display:none">
        ...
        <div class="card-body">
            ...
            <a href="#" data-id="{{ $preset->id }}" data-name="{{ $preset->name }}" class="btn btn-danger" id="enlaceBorrar">Cancel</a>
